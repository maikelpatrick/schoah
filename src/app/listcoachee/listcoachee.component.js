...
var ListcoacheeComponent = /** @class */ (function () {
    function ListcoacheeComponent(coacheesService) {
    ...
    return ListcoacheeComponent;
}());
exports.ListcoacheeComponent = ListcoacheeComponent;
